...
// Create a reference to thelement who's ID is 'big_coffee and call it bigCoffee
...
function unlockProducers(producers, coffeeCount) {
  // loop through the producers array passed into the function for each producer, if the coffeeCount (passed in) is greater than or equal
...
function getUnlockedProducers(data) 
{
  ...
  // filter through the data.producers property, and return an array with
  // only the producers whose unlocked property is true
  
  return data.producers.filter(prod => prod.unlocked);
  //for each element in the array data.producers (prod) return producers if prod.unlocked is true.
}
